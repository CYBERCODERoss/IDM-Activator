...
cls
title  IDM-Activator 2.0 - @nautilus._.shell
mode 65, 25
...
call :_color2 %_White% "        " %_Red% "  Create By nautilus._.shell"
echo:          _____________________________________________   
echo: 
echo:          Telegram: @nautilusShell
echo:          Github: https://github.com/CYBERCODERoss
echo:          _____________________________________________   
echo:                                                          
echo:          [1] Activate IDM                                
...
echo:   
call :_color2 %_White% "        " %_Red% "Enter a menu option in the Keyboard [1,2,3,4,5,6]"
choice /C:123456 /N
set _erl=%errorlevel%
...
start https://github.com/CYBERCODERoss/IDM-Activator
goto MainMenu
